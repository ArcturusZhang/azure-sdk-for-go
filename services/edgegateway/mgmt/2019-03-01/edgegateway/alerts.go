...
func (client AlertsClient) Get(ctx context.Context, deviceName string, name string, resourceGroupName string) (result Alert, err error) {
    ...
    if err != nil {
    err = autorest.NewErrorWithError(err, "edgegateway.AlertsClient", "Get", nil , "Failure preparing request")
    return
    }
            ...
            err = autorest.NewErrorWithError(err, "edgegateway.AlertsClient", "Get", resp, "Failure sending request")
            return
            }

            result, err = client.GetResponder(resp)
            if err != nil {
            err = autorest.NewErrorWithError(err, "edgegateway.AlertsClient", "Get", resp, "Failure responding to request")
            }
...
func (client AlertsClient) ListByDataBoxEdgeDevice(ctx context.Context, deviceName string, resourceGroupName string) (result AlertListPage, err error) {
    ...
    if err != nil {
    err = autorest.NewErrorWithError(err, "edgegateway.AlertsClient", "ListByDataBoxEdgeDevice", nil , "Failure preparing request")
    return
    }
            ...
            err = autorest.NewErrorWithError(err, "edgegateway.AlertsClient", "ListByDataBoxEdgeDevice", resp, "Failure sending request")
            return
            }

            result.al, err = client.ListByDataBoxEdgeDeviceResponder(resp)
            if err != nil {
            err = autorest.NewErrorWithError(err, "edgegateway.AlertsClient", "ListByDataBoxEdgeDevice", resp, "Failure responding to request")
            }
...
func (client AlertsClient) ListByDataBoxEdgeDeviceResponder(resp *http.Response) (result AlertList, err error) {
    ...
    result.Response = autorest.Response{Response: resp}
        return
            ...
            if err != nil {
            return result, autorest.NewErrorWithError(err, "edgegateway.AlertsClient", "listByDataBoxEdgeDeviceNextResults", nil , "Failure preparing next results request")
            }
            if req == nil {
            return
            }
            ...
            if err != nil {
            result.Response = autorest.Response{Response: resp}
            return result, autorest.NewErrorWithError(err, "edgegateway.AlertsClient", "listByDataBoxEdgeDeviceNextResults", resp, "Failure sending next results request")
            }
            result, err = client.ListByDataBoxEdgeDeviceResponder(resp)
            if err != nil {
            err = autorest.NewErrorWithError(err, "edgegateway.AlertsClient", "listByDataBoxEdgeDeviceNextResults", resp, "Failure responding to next results request")
            }
            return
                    }
