...
func (client OperationsClient) List(ctx context.Context) (result OperationsListPage, err error) {
    ...
    if err != nil {
    err = autorest.NewErrorWithError(err, "edgegateway.OperationsClient", "List", nil , "Failure preparing request")
    return
    }
            ...
            err = autorest.NewErrorWithError(err, "edgegateway.OperationsClient", "List", resp, "Failure sending request")
            return
            }

            result.ol, err = client.ListResponder(resp)
            if err != nil {
            err = autorest.NewErrorWithError(err, "edgegateway.OperationsClient", "List", resp, "Failure responding to request")
            }
...
func (client OperationsClient) ListResponder(resp *http.Response) (result OperationsList, err error) {
    ...
    result.Response = autorest.Response{Response: resp}
        return
            ...
            if err != nil {
            return result, autorest.NewErrorWithError(err, "edgegateway.OperationsClient", "listNextResults", nil , "Failure preparing next results request")
            }
            if req == nil {
            return
            }
            ...
            if err != nil {
            result.Response = autorest.Response{Response: resp}
            return result, autorest.NewErrorWithError(err, "edgegateway.OperationsClient", "listNextResults", resp, "Failure sending next results request")
            }
            result, err = client.ListResponder(resp)
            if err != nil {
            err = autorest.NewErrorWithError(err, "edgegateway.OperationsClient", "listNextResults", resp, "Failure responding to next results request")
            }
            return
                    }
