...
func (client JobsClient) Get(ctx context.Context, deviceName string, name string, resourceGroupName string) (result Job, err error) {
    ...
    if err != nil {
    err = autorest.NewErrorWithError(err, "edgegateway.JobsClient", "Get", nil , "Failure preparing request")
    return
    }
            ...
            err = autorest.NewErrorWithError(err, "edgegateway.JobsClient", "Get", resp, "Failure sending request")
            return
            }

            result, err = client.GetResponder(resp)
            if err != nil {
            err = autorest.NewErrorWithError(err, "edgegateway.JobsClient", "Get", resp, "Failure responding to request")
            }
